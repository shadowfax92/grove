...
func TestShadowMaximizeOpensCenteredPopup(t *testing.T) {
	...
	assertLogContains(t, log, "display-popup -c popup-client -w 50% -h 100% -E exec tmux attach-session -t '=gs/vim/7'")
}
...
func TestShadowMaximizeRestoresNormalPopupSize(t *testing.T) {
	...
	assertLogContains(t, log, "display-popup -c popup-client -w 80% -h 85% -E exec tmux attach-session -t '=gs/vim/7'")
}
...
func TestNormalPaneMaximizeSwapsPaneIntoCenteredPopup(t *testing.T) {
	...
	assertLogContains(t, log, "display-popup -c main-client -w 50% -h 100% -E exec tmux attach-session -t '=gm/7'")
}
