...
func TestShadowMaximizeOpensCenteredPopup(t *testing.T) {
	...
	assertLogContains(t, log, "display-popup -c popup-client -w 40% -h 100% -E exec tmux attach-session -t '=gs/vim/7'")
}
...
func TestNormalPaneMaximizeSwapsPaneIntoCenteredPopup(t *testing.T) {
	...
	assertLogContains(t, log, "display-popup -c main-client -w 40% -h 100% -E exec tmux attach-session -t '=gm/7'")
}
